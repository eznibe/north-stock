...
$query = "SELECT DISTINCT
	DATE_FORMAT(orden.fecha, '%d-%m-%Y') AS fecha, 
	orden.id_orden, 
	Proveedor.proveedor  
  FROM 
	orden, 
...
while ($row = $result->fetch(PDO::FETCH_NUM))
{
 $orden = $orden .  "<tr class=\"provlistrow\">
	...
	<td><a class=\"list\" href=\"orden_ver_arribo.php?id_orden=$row[1]\">$row[2]</a></td>
    </tr>\n";
}
...
eval_html('orden_arribo_listar.html', $var);
