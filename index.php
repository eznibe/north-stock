...
<head>
  ...
  <link rel="shortcut icon" href="imagenes/key_lock.gif">
...
{
 mw = window.open("","_self","resizable=1");
 mw.focus();
}
...
<form action="form_login.php" method="post" target="_self" onsubmit="abrir_ventana()" name="auth">
